...
import 'package:instagram_clean/feature/comment/presentation/widget/single_replay_widget.dart';
          ...
          children: [
            Container(
              ...
              child: ClipRRect(
                ...
                child: UserPhoto(imageUrl: widget.comment.userProfileUrl),
              ),
            ),
                    ...
                    _isUserReplaying == true
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Text(
                            "Post",
                            style: Theme.of(context).textTheme.titleSmall!.copyWith(color: AppColors.buttonColor)
                          ),
                        )
                      ],
                    )
