...
class StoryDottedBordersWidget extends CustomPainter {
  //number of stories
  ...
  final String? uid;
  final List<StoryImageEntity>? images;
  final bool isMe;

  //start of the arc painting in degree(0-360)
  double startOfArcInDegree = 0;

  StoryDottedBordersWidget({required this.numberOfStories,
    this.spaceLength = 10,
    this.uid,
    this.images,
    required this.isMe });
  ...
  @override
  bool shouldRepaint(StoryDottedBordersWidget oldDelegate) {
    return true;
  }
